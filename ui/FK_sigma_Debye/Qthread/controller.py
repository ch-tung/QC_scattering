...
class MainWindow_controller(QtWidgets.QMainWindow):
    ...
    def plot_results(self):
        ...
        ax.plot([self.Q_410*self.d_410,self.Q_410*self.d_410],[0,40],'-',color='b')
        ax.plot([self.Q_002*self.d_410,self.Q_002*self.d_410],[0,40],'-',color='g')
        index_qq = (self.qq*self.d_410>4)*(self.qq*self.d_410<8)
        max_S_q = np.max(self.S_q[index_qq])
        ax.set_xlim(2,15)
        ax.set_ylim(-0.5,max_S_q*1.1)
